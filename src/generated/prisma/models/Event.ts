...
export interface EventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Events and only return the `key`
   * const eventWithKeyOnly = await prisma.event.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Events and only return the `key`
   * const eventWithKeyOnly = await prisma.event.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface EventFieldRefs {
  ...
  readonly pointsScored: Prisma.FieldRef<"Event", 'Int'>
  readonly averagePointsPerMatch: Prisma.FieldRef<"Event", 'Int'>
  readonly rpEarned: Prisma.FieldRef<"Event", 'Int'>
  readonly penaltyPoints: Prisma.FieldRef<"Event", 'Int'>
